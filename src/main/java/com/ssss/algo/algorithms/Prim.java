...
public class Prim {
    ...
    static class Graph {
        private List<List<int[]>> adj; // Список смежности: [сосед, вес]
...
//            minHeap.buildMinHeap();
            ...
            while (!minHeap.isEmpty()) {
                ...
                for (int[] neighbor : adj.get(extracted[0])) {
                    if (!visited[neighbor[0]]) {
                        minHeap.decreaseKey(neighbor[0], neighbor[1], extracted[0]);
                    }
                }
                minHeap.print();
            }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Minimum cost (Prim's): " + g.prim(0));
    }
